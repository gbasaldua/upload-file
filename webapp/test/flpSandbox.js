		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#CargadeArchivo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"CargadeArchivo-display": {
								"semanticObject": "CargadeArchivo",
								"action": "display",
								"description": "Carga de Archivo al Backend",
								"title": "Carga de Archivo",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=uploadfile",
									"url": sap.ui.require.toUrl("uploadfile")
								}
							}
						}
					}
